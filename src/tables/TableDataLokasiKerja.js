            ...
            <div className='col-lg-12' style={{ backgroundColor: "white", borderRadius: "5px", marginRight: "15px" }}>
              <nav aria-label="breadcrumb" style={{ marginTop: "10px", marginBottom: "10px" }}>
                <ol className="breadcrumb">
                  <li className="breadcrumb-item active" aria-current="page"><b style={{ color: "black" }}>Data Lokasi Kerja</b></li>
                </ol>
              </nav>
            </div>
          </div>
            ...
            <div className='col-lg-12' style={{ marginTop: "20px" }}>
              <div className='row'>
                ...
                <div className='col' style={{ display: "flex", alignItems: "center", justifyContent: "flex-end" }}>
                  <Link to="/formDataLokasiKerja"><button type="button" className="btn btn-success btn-sm">Tambah Lokasi Kerja</button></Link>
                </div>
              </div>
            </div>
                ...
                <div className="card-header">
                  <div className='row'>
                    <div className='col' style={{ display: "flex", alignItems: "center" }}>
                      <b style={{ fontSize: "14px" }}>Data Lokasi Kerja</b>
                    </div>
                    <div className='col' style={{ display: "flex", alignItems: "center", justifyContent: "flex-end" }}>
                        ...
                        <tr key={item.LokasiKerjaID}>
                          ...
                          <td>
                            <div>
                              ...
                              <FontAwesomeIcon icon={faTrashCan} onClick={() => handleDelete(item.LokasiKerjaID)} style={{ cursor: 'pointer', color: "red" }} data-toggle="tooltip" title="Hapus" data-placement="top" />
                            </div>
                          </td>
                        </tr>
                      ))}
...
export default TableDataLokasiKerja